...
<body>
  ...
  <script>
    ...
    var pusher = new Pusher('e18f2b283d69ef9868e8', {
      cluster: 'mt1',
    ...
    // الاشتراك في القناة الخاصة بالإدمن
    var channel = pusher.subscribe('private-admin-channel');

    // الاستماع للحدث BookBorrowed
    channel.bind('book.borrowed', function(data) {
        alert('الطالب ' + data.studentname + ' قام باستعارة الكتاب: ' + data.book);
    });
</script>
  @yield('script')
